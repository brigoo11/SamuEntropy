...
class Nodes {
    ...
    public static android.graphics.Bitmap BuildB;
    public Nodes(android.view.SurfaceView surfaceView) {
        ...
        resId = surfaceView.getResources().getIdentifier("build1", "drawable",
                "batfai.samuentropy.brainboard7");
        BuildB = android.graphics.BitmapFactory.decodeResource(surfaceView.getResources(), resId);
...
public class NorbironSurfaceView extends android.view.SurfaceView implements Runnable {
  ...
  public static void loadData(android.content.SharedPreferences settings)
    ...
    public void onDraw(android.graphics.Canvas canvas) {
        ...
        if (ClickedBuild == 0)
            {
            	canvas.drawBitmap(nodes.BuildB, null, new android.graphics.Rect(0, 0, 100, 100), null);}
